return{
    ...
    keys = {
        ...
        { "<leader>mge", "<cmd>Neominimap Enable<cr>", desc = "Enable global minimap" },
        { "<leader>mgd", "<cmd>Neominimap Disable<cr>", desc = "Disable global minimap" },
        ...
        { "<leader>mwe", "<cmd>Neominimap WinEnable<cr>", desc = "Enable minimap for current window" },
        { "<leader>mwd", "<cmd>Neominimap WinDisable<cr>", desc = "Disable minimap for current window" },
        ...
        { "<leader>mte", "<cmd>Neominimap TabEnable<cr>", desc = "Enable minimap for current tab" },
        { "<leader>mtd", "<cmd>Neominimap TabDisable<cr>", desc = "Disable minimap for current tab" },
        ...
        { "<leader>mbe", "<cmd>Neominimap BufEnable<cr>", desc = "Enable minimap for current buffer" },
        { "<leader>mbd", "<cmd>Neominimap BufDisable<cr>", desc = "Disable minimap for current buffer" },
